...
// Seasonal Prices 2027 ACF Group
add_action('acf/init', function () {
  if (!function_exists('acf_add_local_field_group')) return;
  ...
  $f27[] = ['key' => 'field_season27_tab_general', 'label' => 'General', 'type' => 'tab', 'placement' => 'top'];
  $f27[] = [
    'key'           => 'field_season27_price_period',
    'label'         => 'Price period',
    'name'          => 'season27_price_period',
    'type'          => 'select',
    'choices'       => ['week' => 'Per week', 'day' => 'Per day'],
    'default_value' => 'week',
    'instructions'  => 'Leave all months empty to hide the 2027 tab on the front end.',
    'wrapper'       => ['width' => 20],
  ];
  $f27[] = [
    'key'          => 'field_season27_min_stay_1',
    'label'        => 'Minimum Stay — Tag 1',
    'name'         => 'season27_min_stay_1',
    'type'         => 'text',
    'placeholder'  => 'e.g. 4 nights minimum — Jan, Feb, Mar',
    'instructions' => 'Leave empty to hide.',
    'wrapper'      => ['width' => 40],
  ...
  $f27[] = [
    'key'          => 'field_season27_min_stay_2',
    'label'        => 'Minimum Stay — Tag 2',
    'name'         => 'season27_min_stay_2',
    'type'         => 'text',
    'placeholder'  => 'e.g. 5 nights minimum — Jun, Jul, Aug',
    'instructions' => 'Leave empty to hide.',
    'wrapper'      => ['width' => 40],
  ...
  foreach ($month_slugs as $i => $slug) {
    ...
    $f27[] = ['key' => "field_season27_{$slug}_tab", 'label' => $label, 'type' => 'tab', 'placement' => 'top'];

    $f27[] = [
      'key'          => "field_season27_{$slug}_price",
      'label'        => 'Price',
      'name'         => "season27_{$slug}_price",
      'type'         => 'text',
      'placeholder'  => 'e.g. 7000 or 7000€ - 8000€',
      'instructions' => 'Number (e.g. 7000) or a text range (e.g. 7000€ - 8000€).',
      'wrapper'      => ['width' => 25],
    ...
    $f27[] = [
      'key'         => "field_season27_{$slug}_label",
      'label'       => 'Season Label',
      'name'        => "season27_{$slug}_label",
      'type'        => 'text',
      'placeholder' => 'e.g. Basse saison',
      'wrapper'     => ['width' => 35],
    ];
    $f27[] = [
      'key'        => "field_season27_{$slug}_color",
      'label'      => 'Season Color',
      'name'       => "season27_{$slug}_color",
      'type'       => 'select',
      'choices'    => [
        'low'      => 'Low (green)',
        'mid'      => 'Mid (yellow)',
    ...
    $f27[] = [
      'key'         => "field_season27_{$slug}_date_from",
      'label'       => 'Available From',
      'name'        => "season27_{$slug}_date_from",
      'type'        => 'text',
      'placeholder' => 'e.g. 1 Jan.',
      'wrapper'     => ['width' => 25],
    ];
    $f27[] = [
      'key'         => "field_season27_{$slug}_date_to",
      'label'       => 'Available To',
      'name'        => "season27_{$slug}_date_to",
      'type'        => 'text',
      'placeholder' => 'e.g. 31 Jan.',
      'wrapper'     => ['width' => 25],
    ];
    $f27[] = [
      'key'         => "field_season27_{$slug}_min_stay",
      'label'       => 'Min. Stay',
      'name'        => "season27_{$slug}_min_stay",
      'type'        => 'text',
      'placeholder' => 'e.g. 4 nights min.',
      'wrapper'     => ['width' => 50],
    ];
  ...
  $f27[] = ['key' => 'field_season27_tab_footer', 'label' => 'Footer', 'type' => 'tab', 'placement' => 'top'];
  $f27[] = [
    'key'         => 'field_season27_footer_note',
    'label'       => 'Note (left)',
    'name'        => 'season27_footer_note',
    'type'        => 'textarea',
    'rows'        => 4,
    'placeholder' => 'Optional note displayed below the 2027 price cards.',
    'wrapper'     => ['width' => 50],
  ];
  $f27[] = [
    'key'         => 'field_season27_price_from',
    'label'       => 'Price From Text (right)',
    'name'        => 'season27_price_from',
    'type'        => 'text',
    'placeholder' => 'e.g. A partir de 6 860 EUR / semaine',
    'wrapper'     => ['width' => 50],
  ];
  $f27[] = [
    'key'         => 'field_season27_book_label',
    'label'       => 'Book Button — Label',
    'name'        => 'season27_book_label',
    'type'        => 'text',
    'placeholder' => 'e.g. Reserver',
    'wrapper'     => ['width' => 30],
  ];
  $f27[] = [
    'key'         => 'field_season27_book_url',
    'label'       => 'Book Button — URL',
    'name'        => 'season27_book_url',
    'type'        => 'url',
    'placeholder' => 'https://...',
    'wrapper'     => ['width' => 70],
  ];
  ...
  acf_add_local_field_group([
    'key'             => 'group_seasonal_prices_2027',
    'title'           => 'Seasonal Prices — 2027',
    'fields'          => $f27,
    'location'        => [[[
      'param'    => 'post_type',
      'operator' => '==',
...
add_action('acf/init', function () {
  if (!function_exists('acf_add_local_field_group')) return;
  acf_add_local_field_group([
    'key'    => 'group_real_estate_page',
    'title'  => 'Real Estate Page',
    'fields' => [
      [
        'key'          => 'field_re_subtitle',
        'label'        => 'Hero Subtitle',
        'name'         => 're_subtitle',
        'type'         => 'text',
        'instructions' => 'Short tagline displayed below the hero (e.g. "A more personal way to buy and sell villas in Puglia.").',
      ],
      [
        'key'          => 'field_re_intro_text',
        'label'        => 'Intro Text',
        'name'         => 're_intro_text',
        'type'         => 'textarea',
        'rows'         => 5,
        'new_lines'    => 'wpautop',
        'instructions' => 'SEO paragraph displayed above the process section. Enter the version for the current language.',
      ],
    ],
    'location' => [[['param' => 'page_template', 'operator' => '==', 'value' => 'real-estate.php']]],
    'position' => 'normal',
  ]);
});
...
function plh_register_ui_strings() {
  ...
  $strings = [
    ...
    'Discover more',
    // Press / TV page
    'Broadcast on July 22, 2026 on TMC',
    'Puglia Luxury Homes on TV',
    ...
    'The very first villa to join our portfolio, Villa Acquamarina sits perched above the turquoise waters of Salento — the place that sparked the entire Puglia Luxury Homes adventure.',
    'In this episode, our team organises an exclusive private boat excursion departing from the villa, exploring the hidden sea caves and crystal-clear bays of the Salento coast.',
    'Discover the villa',
    'Born in Puglia, for the love of Puglia',
    'Puglia Luxury Homes curates an exceptional collection of private villas in Puglia, each paired with a bespoke programme of concierge services — private chefs, boat excursions, wine tastings and more.',
...
function plh_inline_translations() {
  return [
    'fr' => [
      ...
      'Filters'          => 'Filtres',
      'Capacity'         => 'Capacité',
      '6+ guests'        => '6+ personnes',
      '8+ guests'        => '8+ personnes',
      '10+ guests'       => '10+ personnes',
      '12+ guests'       => '12+ personnes',
      '15+ guests'       => '15+ personnes',
      '16+ guests'       => '16+ personnes',
      'Collection'       => 'Collection',
      'Seaside'          => 'Bord de mer',
      'Countryside'      => 'Campagne',
      'Historic center'  => 'Centre historique',
      'Price per night'       => 'Prix par nuit',
      'Price per night (from)' => 'Prix par nuit (à partir de)',
      'Up to €600'            => 'Jusqu\'à 600 €',
      '€600 – €1,200'         => '600 € – 1 200 €',
      '€1,200 – €2,000'       => '1 200 € – 2 000 €',
      '€2,000 – €3,000'       => '2 000 € – 3 000 €',
      '€3,000 – €5,000'       => '3 000 € – 5 000 €',
      'More than €5,000'      => 'Plus de 5 000 €',
      'Any'              => 'Tous',
      'All'              => 'Tous',
      'Reset'            => 'Réinitialiser',
      ...
      'I am looking to:'                         => 'Je souhaite :',
      'Select an option'                         => 'Choisir une option',
      'Buy a property'                           => 'Acheter un bien',
      'Sell a property'                          => 'Vendre un bien',
      'Both'                                     => 'Les deux',
      'Other'                                    => 'Autre',
      ...
      // Press / TV page
      'Broadcast on July 22, 2026 on TMC'        => 'Diffusé le 22 juillet 2026 sur TMC',
      ...
      '9:00 pm'                                  => '21h00',
      'Available after broadcast'                => 'Disponible après diffusion',
      'Coming soon'                              => 'Prochainement',
      'Featured in the episode'                  => 'À l\'honneur dans l\'épisode',
      'The very first villa to join our portfolio, Villa Acquamarina sits perched above the turquoise waters of Salento — the place that sparked the entire Puglia Luxury Homes adventure.' => 'Première villa à rejoindre notre portefeuille, Villa Acquamarina est nichée au-dessus des eaux turquoise du Salento — le lieu qui est à l\'origine de toute l\'aventure Puglia Luxury Homes.',
      'In this episode, our team organises an exclusive private boat excursion departing from the villa, exploring the hidden sea caves and crystal-clear bays of the Salento coast.' => 'Dans cet épisode, notre équipe organise une sortie exclusive en bateau privé au départ de la villa, à la découverte des grottes cachées et des criques cristallines de la côte du Salento.',
      'Discover the villa'                       => 'Découvrir la villa',
      'Born in Puglia, for the love of Puglia'   => 'Nés en Puglia, par amour de la Puglia',
      'Puglia Luxury Homes curates an exceptional collection of private villas in Puglia, each paired with a bespoke programme of concierge services — private chefs, boat excursions, wine tastings and more.' => 'Puglia Luxury Homes sélectionne un portefeuille exceptionnel de villas privées en Puglia, accompagnées d\'un programme de services de conciergerie sur mesure — chef privé, excursions en bateau, dégustations de vins et bien plus.',
      ...
      'I agree to be contacted regarding this enquiry.' => 'J\'accepte d\'être contacté(e) concernant cette demande.',
    ...
    'it' => [
      ...
      'Price per night (from)' => 'Prezzo per notte (a partire da)',
      'Up to €600'            => 'Fino a 600 €',
      '€600 – €1,200'         => '600 € – 1.200 €',
      '€1,200 – €2,000'       => '1.200 € – 2.000 €',
      '€2,000 – €3,000'       => '2.000 € – 3.000 €',
      '€3,000 – €5,000'       => '3.000 € – 5.000 €',
      'More than €5,000'      => 'Più di 5.000 €',
      'Any'              => 'Tutti',
      'All'              => 'Tutti',
      'Reset'            => 'Reimposta',
      ...
      'List'             => 'Lista',
      'Map'              => 'Mappa',
      'villas found'     => 'ville trovate',
      'Loading...'       => 'Caricamento...',
      'No villas match your filters. Please try adjusting your criteria.' => 'Nessuna villa corrisponde ai tuoi filtri. Prova a modificare i criteri.',
      'Error loading villas. Please try again.' => 'Errore nel caricamento delle ville. Riprova.',
      // Real Estate page
      'Start your property journey in Puglia'    => 'Inizia il tuo percorso immobiliare in Puglia',
      'Whether you are looking to find your place in Puglia or considering selling your property, we guide you every step of the way.' => 'Che tu stia cercando la tua casa in Puglia o considerando di vendere la tua proprietà, ti guidiamo in ogni fase.',
      'Full Name'                                => 'Nome e cognome',
      'Email address'                            => 'Indirizzo e-mail',
      'Phone'                                    => 'Telefono',
      'Country of residence'                     => 'Paese di residenza',
      'I am looking to:'                         => 'Sono interessato a:',
      'Select an option'                         => 'Seleziona un\'opzione',
      'Buy a property'                           => 'Acquistare un immobile',
      'Sell a property'                          => 'Vendere un immobile',
      'Both'                                     => 'Entrambi',
      'Other'                                    => 'Altro',
      ...
      // Press / TV page
      'Broadcast on July 22, 2026 on TMC'        => 'Trasmesso il 22 luglio 2026 su TMC',
      ...
      '9:00 pm'                                  => 'ore 21:00',
      'Available after broadcast'                => 'Disponibile dopo la messa in onda',
      'Coming soon'                              => 'Prossimamente',
      'Featured in the episode'                  => 'Protagonista dell\'episodio',
      'The very first villa to join our portfolio, Villa Acquamarina sits perched above the turquoise waters of Salento — the place that sparked the entire Puglia Luxury Homes adventure.' => 'Prima villa a entrare nel nostro portfolio, Villa Acquamarina è affacciata sulle acque turchesi del Salento — il luogo che ha dato vita all\'intera avventura di Puglia Luxury Homes.',
      'In this episode, our team organises an exclusive private boat excursion departing from the villa, exploring the hidden sea caves and crystal-clear bays of the Salento coast.' => 'In questo episodio, il nostro team organizza un\'esclusiva escursione in barca privata con partenza dalla villa, alla scoperta delle grotte nascoste e delle calette cristalline della costa salentina.',
      'Discover the villa'                       => 'Scopri la villa',
      'Born in Puglia, for the love of Puglia'   => 'Nati in Puglia, per amore della Puglia',
      'Puglia Luxury Homes curates an exceptional collection of private villas in Puglia, each paired with a bespoke programme of concierge services — private chefs, boat excursions, wine tastings and more.' => 'Puglia Luxury Homes seleziona una collezione esclusiva di ville private in Puglia, abbinata a un programma di servizi di concierge su misura — chef privato, escursioni in barca, degustazioni di vini e molto altro.',
      ...
      'Your email'                               => 'Email',
      'Subject'                                  => 'Oggetto',
      'Select a subject'                         => 'Seleziona un oggetto',
      'Booking request'                          => 'Richiesta di prenotazione',
      'Concierge service'                        => 'Servizio di concierge',
      'How can we assist you?'                   => 'Come possiamo aiutarti?',
      'I agree to be contacted regarding this enquiry.' => 'Acconsento ad essere contattato/a riguardo a questa richiesta.',
...
function plh_filter_villas() {
  ...
  if ($query->have_posts()) {
    ...
    echo '<p class="no-villas">' . esc_html(plh_t('No villas match your filters. Please try adjusting your criteria.')) . '</p>';
  }
...
function plh_handle_real_estate_inquiry() {
  if ( !isset($_POST['plh_re_inquiry_nonce']) || !wp_verify_nonce($_POST['plh_re_inquiry_nonce'], 'plh_re_inquiry_nonce') ) {
    wp_redirect(add_query_arg(['re_inquiry' => 'error', 're_error' => urlencode('Security check failed.')], wp_get_referer()));
    exit;
  }

  if ( !empty($_POST['re_hp_field']) ) {
    wp_redirect(add_query_arg('re_inquiry', 'error', wp_get_referer()));
    exit;
  }

  $full_name      = sanitize_text_field($_POST['re_full_name'] ?? '');
  $email          = sanitize_email($_POST['re_email'] ?? '');
  $phone          = sanitize_text_field($_POST['re_phone'] ?? '');
  $country        = sanitize_text_field($_POST['re_country'] ?? '');
  $intent         = sanitize_text_field($_POST['re_intent'] ?? '');
  $locations_raw  = isset($_POST['re_locations']) && is_array($_POST['re_locations']) ? $_POST['re_locations'] : [];
  $locations      = array_map('sanitize_text_field', $locations_raw);
  ...
  $t = [
    'en' => [
      ...
      'heading'      => 'New Real Estate Inquiry',
    ...
    'fr' => [
      ...
      'heading'      => 'Nouvelle demande immobilière',
      ...
      'intent'       => 'Objectif',
      'locations'    => 'Zone(s) de préférence',
      'budget'       => 'Budget',
    ...
    'it' => [
      'subject'      => 'Nuova richiesta immobiliare',
      'heading'      => 'Nuova richiesta immobiliare',
  ...
  $body .= '<h2 style="color:#6c9ba3;">' . esc_html($l['heading']) . '</h2>';

  $body .= '<h3 style="color:#6c9ba3;border-bottom:2px solid #f0f0f0;padding-bottom:8px;">' . esc_html($l['contact']) . '</h3>';
  $body .= '<p><strong>' . esc_html($l['full_name']) . ':</strong> ' . esc_html($full_name) . '</p>';
  $body .= '<p><strong>' . esc_html($l['email']) . ':</strong> ' . esc_html($email) . '</p>';
  $body .= '<p><strong>' . esc_html($l['phone']) . ':</strong> ' . esc_html($phone) . '</p>';
  $body .= '<p><strong>' . esc_html($l['country']) . ':</strong> ' . esc_html($country ?: $l['not_provided']) . '</p>';

  $body .= '<h3 style="color:#6c9ba3;border-bottom:2px solid #f0f0f0;padding-bottom:8px;">' . esc_html($l['project']) . '</h3>';
  $body .= '<p><strong>' . esc_html($l['intent']) . ':</strong> ' . esc_html($intent) . '</p>';
  $body .= '<p><strong>' . esc_html($l['locations']) . ':</strong> ' . esc_html(implode(', ', $locations)) . '</p>';
  ...
  $body .= '<p style="color:#888;font-size:12px;"><em>' . esc_html($l['submitted_on']) . ' ' . date('F j, Y \a\t g:i a') . '</em></p>';
  $body .= '</body></html>';

  $sent = wp_mail($to, $subject, $body, $headers);

  if ( $sent ) {
    wp_redirect(add_query_arg('re_inquiry', 'success', wp_get_referer()));
  } else {
    wp_redirect(add_query_arg(['re_inquiry' => 'error', 're_error' => urlencode('Failed to send. Please try again.')], wp_get_referer()));
  }
  exit;
}
